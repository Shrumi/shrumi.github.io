...
let nameCity = 'Волгоград';
let  nameCountry = 'Россия';
let countPeople = 1000000;
let  stadium = true;
console.log('Задание 1:');
console.log('Название города: ' + nameCity);
console.log('Название страны: ' +  nameCountry);
console.log('Население: ' + countPeople + ' чел.' );
console.log('Есть ли стадион: ' + stadium);
console.log('                        ');
...
*/
let high = 40, wide = 70, square = high * wide;
console.log('Задание 2: ');
console.log (`Площадь = ${square} см`);
console.log('                        ');
...
speedOfFirst = 95,
    speedOfSecond = 114,
    dist = (speedOfFirst * time) + (speedOfSecond * time);
